...
const Admin = () => {
    return (
        <div className="choice">
            ...
            <ChoiceCard link={"/all-product"} title="Все товары" subtitle="Добавить | Удалить" bgColor="#000001" color="#FAF4E6"/>
            <ChoiceCard link={"/"} title="Убрать" subtitle="Из магазина" bgColor="#000001" color="#FAF4E6"/>
